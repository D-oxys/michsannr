              ...
              <div className="md:col-span-1">
                <div className="px-0 py-6 md:px-8">
                  <form className="flex flex-col gap-6" action="#">
                    ...
                    <button type="button" className="my-5 mb-2 mr-2 w-full rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-700 md:w-[170px]">
                      Send Message
                    </button>
                  </form>
                </div>
